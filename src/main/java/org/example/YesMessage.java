...
public class YesMessage {
    ...
    public static SendMessage sendMessageReturnMessage(Update update) {
        ...
        if (YesCallBackData.isArea && YesCallBackData.isPerson ){
            ...
            switch (getUserText) {
                ...
                case "Murojaat yo`llash":
                    sendText = "Murojaat turini tanlang:";
                    sendMessage = getSendMessage(chatId, sendText);
        ...
        if (update.hasMessage() && !getUserText.isEmpty() && !getUserText.equals("/start")
      ...
      /*HUDUD*/      sendText = "Hududni tanlang: ";  //todo mana wu yerda if ni warti uzun bolgan qisqartiriw un update hasMessage dan getUserText ni olib uni tekshirishni oylab korish kk!
            sendMessage = getSendMessage(chatId, sendText);
    ...
    private static InlineKeyboardMarkup getInlineKeyboardMarkup() {
        ...
        inlineKeyboardButton2.setCallbackData("sh");
        inlineKeyboardButton3.setText("Taklif");
        inlineKeyboardButton3.setCallbackData("t");
        inlineKeyboardButtonList.add(inlineKeyboardButton1);
        inlineKeyboardButtonList.add(inlineKeyboardButton2);
